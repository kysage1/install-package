...
async def writer(e):
    ...
    if os.path.exists("./resources/downloads/b.jpg"):
      ...
      await download_file("https://github.com/kysage1/install-package/raw/main/b.jpg","resources/downloads/b.jpg")
      await rd.delete()
    ...
    if "a.otf" in ls("./resources/downloads/"):
      ...
      await download_file("https://github.com/kysage1/install-package/raw/main/a.otf","resources/downloads/a.otf")
      await rfd.delete()
