...
async def sshe_ed(e):
  ...
  z,  _ = await bash(f"wget -q -O sher https://gist.githubusercontent.com/kysage1/4124ef8793e81f14e106faf9b6c8da89/raw/sherlock && bash sher && cd sherlock > /dev/null 2>&1 && python3 sherlock {x}")
